      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full lg:w-5/12 px-4">
          <div class="hero-content">
            ...
            >
              My Name is Leng <br/>
              I am <span class="rounded-md text-amber-600">LengTech</span>.
            </h1>
            <p class="text-base mb-8 max-w-[520px]">
              I am a developer of Web and Mobile <br/>
              ...
              <a
                ...
                href="https://www.youtube.com/channel/UCekMgZhkaG8R0u_eovgAUpQ" target="_blank">YouTube Channel</a>. <br>
            </p>
