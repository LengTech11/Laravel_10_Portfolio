        ...
        <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
          <div class="mt-10 lg:mt-0">
            ...
            <p class="text-base dark:text-gray-400 mb-8">
              I a fresh student that just complete a PHP and Laravel and Flutter course with a Institute in Cambodia. <br />
              During my career I have worked as a Freelancer with Website marketplace and RealEstate project with Php and Some of JavaScript Technology,
              but very often I feel that I am a junior developer who just started coding. <br />
            </p>
            <p class="text-base dark:text-gray-400 mb-8">
              In 2023 I decided to create a YouTube channel and share my knowledge. My channel is mostly focused on
